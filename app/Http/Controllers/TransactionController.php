...
class TransactionController extends Controller
{
	...
	public function barChartStatistics(Request $request)
	{
		...
		$rows = Transaction::query()
			...
			SUM(CASE WHEN tracker_id = 2 AND willPay = 0 AND tracker_id != 3 THEN amount ELSE 0 END) as total_partners,
			SUM(CASE WHEN tracker_id = 2 AND pending = 0 AND tracker_id != 3 THEN n_clients ELSE 0 END) as n_client_partners,
